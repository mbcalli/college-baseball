...
def get_player_df(player_name: str, processed_batting: pd.DataFrame, raw_batting: pd.DataFrame) -> pd.DataFrame:
...
def get_player_batting_figure(player_name: str, processed_batting: pd.DataFrame, raw_batting: pd.DataFrame):
    ...
    player_df = get_player_df(player_name, processed_batting, raw_batting)
